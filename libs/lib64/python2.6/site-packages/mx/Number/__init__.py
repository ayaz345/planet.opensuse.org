...
class modinit:
    ...
    def pickle_Float(self, str=str):
        return _F, (str(self), self.precision)

    def pickle_Rational(self, str=str):
        return _R, (str(self.numerator), str(self.denominator))

    def pickle_Integer(self, str=str):
        return _I, (str(self), )
